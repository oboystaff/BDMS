$(document).ready(function () {
    ...
    $('.generate_report').on('click', function(event) {
        ...
        var territory_id = $('select[name="territory_id"]').val();
        ...
        if ($('select[name="report_type"]').val() == 1) {
            ...
            load_data(from_date, to_date, status, report_type, region_id, zone_id, territory_id);
        } else {
            $('#summary').show();
            $('#details').hide();
            $('#graph').show();
    ...
    function load_data(from_date = '', to_date = '', status = '', report_type = '', region_id = '', zone_id = '', territory_id = '') {
        var url = $("input[name='bookshop-report_url']").attr("url");
        ...
        try {
            $('#example4').DataTable({
               ...
               columns: [
                    ...
                    {data: 'gps_location', name: 'gps_location'},
                    ...
                    {data: 'zonal_officer', name: 'zonal_officer'},
