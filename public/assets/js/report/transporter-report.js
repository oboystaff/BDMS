$(document).ready(function () {
    ...
    function load_data(from_date = '', to_date = '', status = '', report_type = '') {
        var url = $("input[name='transporter-report_url']").attr("url");
        ...
        try {
            $('#example4').DataTable({
               ...
               columns: [
                    ...
                    {data: 'transporter_id', name: 'transporter_id'},
        ...
        try {
            $('#example5').DataTable({
               ...
               columns: [
                    ...
                    {data: 'transporter_status', name: 'transporter_status'},

                    {data: 'transporter_number', name: 'transporter_number'},
    ...
    function loadPieChart(from_date = '', to_date = '', status = '') {
        var url = $("input[name='transporter-graph_url']").attr("url");
            ...
            success: function(response) {
                ...
                var myPieChart = new Chart(ctx, {
                    ...
                    options: {
                        ...
                        title: {
                            display: true,
                            text: 'Transporter Summary Report'
                        }
                    }
                });
            },
                    ...
                    options: {
                        ...
                        scales: {
                            ...
                            yAxes: [{
                                scaleLabel: {
                                    display: true,
                                    labelString: 'Number of transporters'
                                }
                            }]
                        }
                    }
