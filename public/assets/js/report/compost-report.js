$(document).ready(function () {
    ...
    $('.generate_report').on('click', function(event) {
        ...
        var compost_type = $('select[name="compost_type"]').val();
        ...
        if ($('select[name="report_type"]').val() == 1) {
            ...
            load_data(from_date, to_date, compost_type, company_id, site_id, report_type, status);
        } else {
            $('#summary').show();
            $('#details').hide();
            $('#graph').show();
            $('#example5').DataTable().destroy();
            load_summary(from_date, to_date, compost_type, company_id, site_id, report_type, status);
            loadPieChart(from_date, to_date, compost_type, company_id, site_id, status);
            loadBarChart(from_date, to_date, compost_type, company_id, site_id, status);
        }
    });

    function load_data(from_date = '', to_date = '', compost_type = '', company_id = '', site_id = '', report_type = '', status = '') {
        var url = $("input[name='compost-report_url']").attr("url");
        ...
        try {
            $('#example4').DataTable({
               ...
               columns: [
                    ...
                    {data: 'compost_type', name: 'compost_type'},
    ...
    function load_summary(from_date = '', to_date = '', compost_type = '', company_id = '', site_id = '', report_type = '', status = '') {
        var url = $("input[name='compost-report_url']").attr("url");
