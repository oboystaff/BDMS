$(document).ready(function () {
    ...
    function load_data(from_date = '', to_date = '', status = '', report_type = '') {
        var url = $("input[name='driver-report_url']").attr("url");
        ...
        try {
            $('#example4').DataTable({
               ...
               columns: [
                    ...
                    {data: 'license_category', name: 'license_category'},
    ...
    function loadPieChart(from_date = '', to_date = '', status = '') {
        var url = $("input[name='driver-graph_url']").attr("url");
