        ...
        <div class="col-lg-12">
            <div class="card dz-card" id="accordion-four">
                <div class="card-header flex-wrap d-flex justify-content-between">
                    <div>
                        <h4 class="card-title">View Book Sales</h4>
                    </div>

                    <div>
                        <a href="{{ route('sales.client_request') }}" class="btn btn-primary btn-sm ms-2">+ Add
                            Book Sale</a>
                    </div>
                </div>
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <div class="py-2">
                                                                <a class="dropdown-item"
                                                                    href="{{ route('sales.show', $sale) }}">View
                                                                </a>
                                                                @if ($sale->status === 'Pending')
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('sales.confirm', $sale) }}">Confirm
                                                                        Distribution
                                                                    </a>
                                                                @endif
                                                            </div>
