        ...
        <div class="col-lg-12">
            <div class="card dz-card" id="accordion-four">
                <div class="card-header flex-wrap d-flex justify-content-between">
                    <div>
                        <h4 class="card-title">View Available Book Request</h4>
                    </div>

                    <div>
                        <a href="{{ route('sales.index') }}" class="btn btn-primary btn-sm ms-2">back</a>
                    </div>
                </div>
                        ...
                        <div class="card-body pt-0">
                            <div class="table-responsive">
                                <table id="example4" class="display table table-striped" style="width: 100%">
                                    ...
                                    <tbody>
                                        @foreach ($clientRequests as $index => $clientRequest)
                                            <tr>
                                                <td>{{ $index + 1 }}</td>
                                                            ...
                                                            <div class="py-2">
                                                                @if ($clientRequest->status === 'Pending')
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('sales.make_sales', $clientRequest) }}">Make
                                                                        Book Sales
                                                                    </a>
                                                                @endif
                                                            </div>
