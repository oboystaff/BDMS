        ...
        <div class="col-lg-12">
            <div class="card dz-card" id="accordion-four">
                <div class="card-header flex-wrap d-flex justify-content-between">
                    <div>
                        <h4 class="card-title">View Book Return Report</h4>
                    </div>
                </div>

                <input type="hidden" name="return-report_url" url="{{ route('return-reports.index') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4" style="display:none">
                                ...
                                <select class="form-select @error('report_type') is-invalid @enderror" id="report_type"
                                    name="report_type">
                                    <option value="1">Return Report</option>
...
@section('page-scripts')
    <script src="{{ asset('assets/js/report/return-report.js?v1=' . time()) }}"></script>
@endsection
