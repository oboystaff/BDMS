        ...
        <div class="col-lg-12">
            <div class="card dz-card" id="accordion-four">
                <div class="card-header flex-wrap d-flex justify-content-between">
                    <div>
                        <h4 class="card-title">View Client Request Report</h4>
                    </div>
                </div>

                <input type="hidden" name="request-report_url" url="{{ route('request-reports.index') }}">
...
@section('page-scripts')
    <script src="{{ asset('assets/js/report/request-report.js?v1=' . time()) }}"></script>
@endsection
