        ...
        <div class="col-lg-6 col-lg-12">
            <div class="card">
                <div class="card-header flex-wrap d-flex justify-content-between">
                    <div>
                        <h4 class="card-title">Add Requisition Form</h4>
                    </div>
                        ...
                        <form method="POST" action="{{ route('requisitions.store') }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="text" name="level"
                                            ...
                                            placeholder="Level Name" value="{{ $book->level->name ?? 'N/A' }}" readonly>
                            ...
                            @else
                                <div class="alert alert-danger alert-dismissible fade show">
                                    ...
                                    <strong>SORRY THIS PAGE IS ONLY ACCESSIBLE BY THE ZONAL SALES OFFICER BUT IF YOU INSIST
                                        ON ACCESSING THIS PAGE, CONTACT THE SYSTEM ADMIN.</strong>
                                </div>
                            @endif
                        </form>
                    </div>
