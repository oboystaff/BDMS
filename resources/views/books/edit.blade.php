                            ...
                            <div class="row">
                                    ...
                                    <select class="form-control default-select @error('subject_id') is-invalid @enderror"
                                        ...
                                        @foreach ($subjects as $subject)
                                            <option value="{{ $subject->id }}"
                                                {{ $book->subject_id == $subject->id ? 'selected' : '' }}>
                                                {{ $subject->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select class="form-control default-select @error('level_id') is-invalid @enderror"
                                        ...
                                        @foreach ($levels as $level)
                                            <option value="{{ $level->id }}"
                                                {{ $book->level_id == $level->id ? 'selected' : '' }}>
                                                {{ $level->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="text" name="unit_price"
                                        ...
                                        placeholder="Unit Price" value="{{ $book->unit_price }}">
                                ...
                                <div class="mb-4 col-md-6">
                                    <label class="form-label">Quantity <span style="color:green">(Note: You cannot update
                                            the quantity here, use the New Stock in the action)</span></label>
