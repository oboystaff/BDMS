        ...
        <div class="col-lg-6 col-lg-12">
            <div class="card">
                <div class="card-header flex-wrap d-flex justify-content-between">
                    <div>
                        <h4 class="card-title">Edit Bookshop</h4>
                    </div>
                            ...
                            <div class="row">
                                    ...
                                    <select name="region_id"
                                        ...
                                        @foreach ($regions as $region)
                                            <option value="{{ $region->id }}"
                                                {{ $bookshop->region_id == $region->id ? 'selected' : '' }}>
                                                {{ $region->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select name="zone_id"
                                        ...
                                        @foreach ($zones as $zone)
                                            <option value="{{ $zone->id }}"
                                                {{ $bookshop->zone_id == $zone->id ? 'selected' : '' }}>
                                                {{ $zone->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select name="territory_id"
                                        ...
                                        @foreach ($territories as $territory)
                                            <option value="{{ $territory->id }}"
                                                {{ $bookshop->territory_id == $territory->id ? 'selected' : '' }}>
                                                {{ $territory->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select name="zonal_sales_officer_id"
                                        ...
                                        @foreach ($zonalSalesOfficers as $officer)
                                            <option value="{{ $officer->id }}"
                                                {{ $bookshop->zonal_sales_officer_id == $officer->id ? 'selected' : '' }}>
                                                {{ $officer->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="number" step="any" name="longitude"
                                        ...
                                        placeholder="Longitude" value="{{ $bookshop->longitude }}">
